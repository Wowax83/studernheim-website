...
return ( <section id="feste" className="py-20"> <div className="max-w-7xl mx-auto px-4">
                  ...
                  fest.highlights.length > 0 && (
                    <div className="flex flex-wrap gap-2 mt-2">
                      {fest.highlights.map((item: any, i: number) => {
                        ...
                        // 👉 Text kommt IMMER aus Sanity
                        let label = item?.text || 'Link'

                        // 👉 Nur Styling / Icon ändern
